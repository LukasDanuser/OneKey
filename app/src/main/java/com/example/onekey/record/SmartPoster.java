package com.example.onekey.record;
...
import com.example.onekey.NdefMessageParser;
import com.example.onekey.R;
...
public class SmartPoster implements ParsedNdefRecord {
    ...
    public View getView(Activity activity, LayoutInflater inflater, ViewGroup parent, int offset) {
        if (mTitleRecord != null) {
            ...
            container.setLayoutParams(new ActionBar.LayoutParams(ActionBar.LayoutParams.MATCH_PARENT,
