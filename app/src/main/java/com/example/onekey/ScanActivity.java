...
import com.example.onekey.record.ParsedNdefRecord;
...
public class ScanActivity extends Activity {
        ...
        for (String tech : tag.getTechList()) {
            if (tech.equals(MifareClassic.class.getName())) {
                ...
                try {
                    ...
                    sb.append("Data: ");
                    String myData = "";
                    for (int i = 0; i < mifareTag.getBlockCount(); i++) {
                        mifareTag.connect();
                        myData = new String(mifareTag.readBlock(mifareTag.sectorToBlock(i)), StandardCharsets.UTF_8);
                        mifareTag.close();
                    }
                    sb.append(myData);
                } catch (Exception e) {
    ...
    void buildTagViews(NdefMessage[] msgs) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            Intent intent = new Intent(ScanActivity.this, CreateActivity.class);
